...
option = st.sidebar.radio("Part II - Regression Task", ['Sampling Techniques', 'Performance Metrics','Hyperparameter Tuning'])
    ...
    def main():
        ...
        if uploaded_file is not None:
            ...
            st.write(
                ...
                - **0 < MSE < 10**: Good performance, predictions are close.
                - **10 ≤ MSE < 100**: Moderate performance, some error.
                - **MSE ≥ 100**: Poor performance, significant prediction error.
                """
            )
        else:
    ...
    def main():
        ...
        if uploaded_file is not None:
            ...
            st.write(
                ...
                - **0 < MAE < 10**: Good performance, predictions are close.
                - **10 ≤ MAE < 50**: Moderate performance, some error.
                - **MAE ≥ 50**: Poor performance, significant error.
            """)
        else:
            st.write("Please upload a CSV file to proceed.")
        st.write("<br><br>", unsafe_allow_html=True)    
...
# Hyperparameter Tuning
    ...
    def main():
        # Load the dataset
        filename = r"C:\Users\Jamaica Marie Canedo\Downloads\lab3.2\water.csv"
        ...
        with tabs[0]:
            ...
            st.write("""
                ...
                - **MAE**: Lower MAE indicates better model performance.
                - **Max Depth**: Higher values capture more details but may overfit.
                - **Min Samples Split/Leaf**: Higher values reduce complexity and overfitting.
        ...
        with tabs[9]:
            ...
            st.write("""
                ...
                - **MAE**: Smaller MAE means better accuracy.
    - **Standard Deviation of MAE**: Smaller values indicate more consistent performance.
    - **Kernel Choice**: Use **linear** for linear datasets and **rbf** for non-linear datasets.
    - **C (Regularization)**: Higher values reduce errors but may overfit; lower values prevent overfitting but may underfit.
    - **Epsilon**: Smaller values make the model more sensitive to errors.
